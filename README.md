# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 455,028 | 🐛 62 | 📅 2026-04-02 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,055 | 🐛 2 | 🌐 Python | 📅 2026-03-23 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 292,182 | 🐛 19 | 🌐 Python | 📅 2026-04-14. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,291 | 🐛 1,022 | 🌐 Python | 📅 2026-04-12
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,342 | 🐛 93 | 🌐 TypeScript | 📅 2026-04-07 integration for Wagtail as textfield widget.
...
* [wagtail-markdown](https://github.com/torchbox/wagtail-markdown) ⭐ 217 | 🐛 13 | 🌐 Python | 📅 2026-04-13 - Markdown fields and blocks for Wagtail.
...
* [wagtail-color-panel](https://github.com/marteinn/wagtail-color-panel) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2026-04-12 - Introduces panels for selecting colors in Wagtail.
...
* [wagtail-inventory](https://github.com/cfpb/wagtail-inventory) ⭐ 64 | 🐛 3 | 🌐 Python | 📅 2026-04-13 - Search Wagtail pages by the StreamField blocks they contain.
...
* [Wagtail-Flags](https://github.com/cfpb/wagtail-flags) ⭐ 90 | 🐛 2 | 🌐 Python | 📅 2026-04-10 - Feature flags for Wagtail sites.
...
* [wagtail-2fa](https://github.com/labd/wagtail-2fa) ⭐ 93 | 🐛 18 | 🌐 Python | 📅 2026-04-03 - Add two-factor authentication to Wagtail by integrating it with django-otp.
...
* [Wagtail Simple Captcha](https://github.com/acarasimon96/wagtail-django-simple-captcha) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2020-05-06 - A self-hosted alternative to Wagtail ReCaptcha that easily integrates a [django-simple-captcha](https://github.com/mbi/django-simple-captcha) ⭐ 1,426 | 🐛 39 | 🌐 Python | 📅 2025-12-07 field into the Wagtail form builder.
* [Wagtail's built in Form Builder](https://docs.wagtail.org/en/stable/reference/contrib/forms/) for general use cases.

### Testing

* [Wagtail Factories](https://github.com/wagtail/wagtail-factories) ⭐ 112 | 🐛 25 | 🌐 Python | 📅 2026-04-14 - Factory boy classes for Wagtail.
...
* [Wagtail Accessibility](https://github.com/wagtail-nest/wagtail-accessibility) ⭐ 34 | 🐛 7 | 🌐 Python | 📅 2026-04-13 – A plugin to assist with accessibility when developing in Wagtail.
...
* [Wagtail Content Import](https://github.com/torchbox/wagtail-content-import) ⭐ 37 | 🐛 7 | 🌐 Python | 📅 2026-04-13 - Import content from Google Docs or Docx into StreamFields, using a customisable mapping system.
...
* [wagtailmenus](https://github.com/jazzband/wagtailmenus) ⭐ 420 | 🐛 20 | 🌐 Python | 📅 2026-04-02 - An extension for Torchbox's Wagtail CMS to help you manage and render multi-level navigation and simple flat menus in a consistent, flexible way.
...
* [Wagtail Pipit](https://github.com/Frojd/Wagtail-Pipit) ⭐ 254 | 🐛 41 | 🌐 Python | 📅 2026-04-14 – Pipit is a Wagtail boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 66 | 🐛 41 | 🌐 Python | 📅 2026-04-13 - Wagtail template and starter kit from the French government.
...
* [cookiecutter-wagtail-vix](https://github.com/engineervix/cookiecutter-wagtail-vix) ⭐ 39 | 🐛 13 | 🌐 Python | 📅 2026-04-13 - A matteries-included, reusable project skeleton to serve as a starting point for a Wagtail project.
...
* [cookiecutter-wagtail-package](https://github.com/wagtail/cookiecutter-wagtail-package) ⭐ 21 | 🐛 3 | 🌐 Python | 📅 2026-04-12 - A cookiecutter template for building Wagtail add-on packages.
...
* [Wagtail news template](https://github.com/wagtail/news-template) ⭐ 167 | 🐛 72 | 🌐 Python | 📅 2026-03-13
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,291 | 🐛 1,022 | 🌐 Python | 📅 2026-04-12 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,074 | 🐛 42 | 🌐 Python | 📅 2026-04-14 – Next generation Wagtail demo, born in Reykjavík.
...
* [Outreachy website](https://github.com/outreachy/website/) ⭐ 297 | 🐛 210 | 🌐 HTML | 📅 2026-04-09 - Website for Outreachy, who provide internships in open source and open science.
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 482 | 🌐 Python | 📅 2026-04-13 – The content management system (CMS) for the new Federal Election Commission website.
...
* [WesternFriend](https://github.com/WesternFriend/westernfriend.org) ⭐ 61 | 🐛 23 | 🌐 Python | 📅 2026-04-10 - community website with directory, ecommerce, and online subscription
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 42 | 🐛 81 | 🌐 Python | 📅 2026-04-10 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
...
* [torchbox.com](https://github.com/torchbox/torchbox.com) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-04-13 – Wagtail build of Torchbox.com.
