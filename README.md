# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,614 | 🐛 71 | 📅 2026-05-03 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,092 | 🐛 0 | 🌐 Python | 📅 2026-04-20 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 296,008 | 🐛 17 | 🌐 Python | 📅 2026-05-04. :snake:*
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,391 | 🐛 93 | 🌐 TypeScript | 📅 2026-04-19 integration for Wagtail as textfield widget.
...
* [wagtail-2fa](https://github.com/labd/wagtail-2fa) ⭐ 95 | 🐛 22 | 🌐 Python | 📅 2026-04-28 - Add two-factor authentication to Wagtail by integrating it with django-otp.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 66 | 🐛 45 | 🌐 Python | 📅 2026-04-29 - Wagtail template and starter kit from the French government.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,076 | 🐛 46 | 🌐 Python | 📅 2026-05-05 – Next generation Wagtail demo, born in Reykjavík.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 43 | 🐛 82 | 🌐 Python | 📅 2026-05-04 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
