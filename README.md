# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,208 | 🐛 75 | 📅 2026-03-09 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,018 | 🐛 0 | 🌐 Python | 📅 2026-03-04 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 286,453 | 🐛 20 | 🌐 Python | 📅 2026-03-04. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,229 | 🐛 1,029 | 🌐 Python | 📅 2026-03-04
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,273 | 🐛 87 | 🌐 TypeScript | 📅 2026-02-16 integration for Wagtail as textfield widget.
...
* [wagtail-schema.org](https://github.com/neon-jungle/wagtail-schema.org) ⭐ 77 | 🐛 4 | 🌐 Python | 📅 2026-02-17 - Schema.org JSON-LD tags for Wagtail sites.
...
* [Wagtail Localize](https://github.com/wagtail/wagtail-localize) ⭐ 248 | 🐛 155 | 🌐 Python | 📅 2026-02-27 - A translation plugin for the Wagtail CMS, allows pages or snippets to be translated within Wagtail's admin interface.
* [Wagtail Modeltranslation](https://github.com/infoportugal/wagtail-modeltranslation) ⭐ 155 | 🐛 29 | 🌐 Python | 📅 2026-02-03 - Simple app containing a mixin model that integrates [django-modeltranslation](https://github.com/deschler/django-modeltranslation) ⭐ 1,471 | 🐛 131 | 🌐 Python | 📅 2026-03-01 into Wagtail panels system.
...
* [Wagtail Factories](https://github.com/wagtail/wagtail-factories) ⭐ 110 | 🐛 25 | 🌐 Python | 📅 2026-02-10 - Factory boy classes for Wagtail.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 64 | 🐛 36 | 🌐 Python | 📅 2026-03-09 - Wagtail template and starter kit from the French government.
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,229 | 🐛 1,029 | 🌐 Python | 📅 2026-03-04 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,073 | 🐛 64 | 🌐 Python | 📅 2026-03-10 – Next generation Wagtail demo, born in Reykjavík.
...
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 488 | 🌐 Python | 📅 2026-03-09 – The content management system (CMS) for the new Federal Election Commission website.
...
* [WesternFriend](https://github.com/WesternFriend/westernfriend.org) ⭐ 61 | 🐛 24 | 🌐 Python | 📅 2026-03-06 - community website with directory, ecommerce, and online subscription
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 42 | 🐛 78 | 🌐 Python | 📅 2026-03-05 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
* [Wagtail user guide](https://github.com/wagtail/guide) ⭐ 33 | 🐛 71 | 🌐 Python | 📅 2026-03-09 - A website to teach Wagtail to content editors, moderators and administrators.
...
* [torchbox.com](https://github.com/torchbox/torchbox.com) ⭐ 8 | 🐛 7 | 🌐 Python | 📅 2026-03-09 – Wagtail build of Torchbox.com.
