# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,163 | 🐛 73 | 📅 2026-05-03 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,092 | 🐛 0 | 🌐 Python | 📅 2026-04-20 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 295,858 | 🐛 16 | 🌐 Python | 📅 2026-05-04. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,308 | 🐛 994 | 🌐 Python | 📅 2026-05-01
...
* [WagtailDraftail](https://github.com/springload/wagtaildraftail) ⭐ 24 | 🐛 20 | 🌐 Python | 📅 2017-11-08 – Draft.js editor for Wagtail, built upon [Draftail](https://github.com/springload/draftail) ⭐ 631 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-23 and [draftjs\_exporter](https://github.com/springload/draftjs_exporter) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-04-23.
...
* [Wagtail Terms](https://github.com/smark-1/wagtailterms) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - A plugin to add a glossary terms entity to the Draftail editor.
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,388 | 🐛 93 | 🌐 TypeScript | 📅 2026-04-19 integration for Wagtail as textfield widget.
...
* [wagtail-autocomplete](https://github.com/wagtail/wagtail-autocomplete) ⭐ 130 | 🐛 55 | 🌐 Python | 📅 2026-04-30 - Autocompleting choosers for `ForeignKey`, `ParentalKey`, and `ManyToMany` fields.
* [wagtail-generic-chooser](https://github.com/wagtail/wagtail-generic-chooser) ⭐ 116 | 🐛 14 | 🌐 Python | 📅 2025-06-06 - provides base classes for building chooser popups and form widgets for the Wagtail admin, matching the look and feel of Wagtail's built-in choosers for pages, documents, snippets and images.
...
* [Wagtail Code Block](https://github.com/wagtail-nest/wagtailcodeblock) ⭐ 171 | 🐛 5 | 🌐 Python | 📅 2026-05-02 - StreamField code blocks for the Wagtail CMS with real-time PrismJS Syntax Highlighting.
...
* [Wagtail-bakery](https://github.com/wagtail-nest/wagtail-bakery) ⭐ 194 | 🐛 19 | 🌐 Python | 📅 2026-05-03 - A set of helpers for baking your Django Wagtail site out as flat files.
...
* [Wagtail Personalisation](https://github.com/wagtail-nest/wagtail-personalisation) ⭐ 128 | 🐛 56 | 🌐 Python | 📅 2026-05-03 - Personalisation module, enabling editors to create customised pages - or parts of pages - based on segments whose rules are configured directly in the admin interface.
* [Wagtail Experiments](https://github.com/torchbox/wagtail-experiments) ⭐ 108 | 🐛 9 | 🌐 Python | 📅 2025-12-16 – A/B testing for Wagtail.

### Security

* [wagtail-2fa](https://github.com/labd/wagtail-2fa) ⭐ 94 | 🐛 22 | 🌐 Python | 📅 2026-04-28 - Add two-factor authentication to Wagtail by integrating it with django-otp.
...
* [Wagtail Localize](https://github.com/wagtail/wagtail-localize) ⭐ 250 | 🐛 163 | 🌐 Python | 📅 2026-04-06 - A translation plugin for the Wagtail CMS, allows pages or snippets to be translated within Wagtail's admin interface.
...
* [Wagtail ReCaptcha](https://github.com/wagtail-nest/wagtail-django-recaptcha) ⭐ 62 | 🐛 13 | 🌐 Python | 📅 2026-04-18 - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha](https://github.com/django-recaptcha/django-recaptcha) ⭐ 1,036 | 🐛 22 | 🌐 Python | 📅 2026-04-27 field when using the Wagtail formbuilder.
...
* [Wagtail Factories](https://github.com/wagtail/wagtail-factories) ⭐ 112 | 🐛 24 | 🌐 Python | 📅 2026-04-23 - Factory boy classes for Wagtail.
...
* [Wagtail Accessibility](https://github.com/wagtail-nest/wagtail-accessibility) ⭐ 35 | 🐛 7 | 🌐 Python | 📅 2026-04-13 – A plugin to assist with accessibility when developing in Wagtail.
...
* [Wagtail Headless Preview](https://github.com/torchbox/wagtail-headless-preview) ⭐ 138 | 🐛 6 | 🌐 Python | 📅 2026-04-06 - Previews for headless Wagtail setups
...
* [Wagtail Content Import](https://github.com/torchbox/wagtail-content-import) ⭐ 37 | 🐛 7 | 🌐 Python | 📅 2026-04-27 - Import content from Google Docs or Docx into StreamFields, using a customisable mapping system.
...
* [wagtailmenus](https://github.com/jazzband/wagtailmenus) ⭐ 421 | 🐛 20 | 🌐 Python | 📅 2026-04-24 - An extension for Torchbox's Wagtail CMS to help you manage and render multi-level navigation and simple flat menus in a consistent, flexible way.
...
* [Wagtail Pipit](https://github.com/Frojd/Wagtail-Pipit) ⭐ 254 | 🐛 43 | 🌐 Python | 📅 2026-04-22 – Pipit is a Wagtail boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 66 | 🐛 44 | 🌐 Python | 📅 2026-04-29 - Wagtail template and starter kit from the French government.
* [Wordpress to Wagtail migration kit](https://github.com/wagtail/wagtail-wordpress-import) ⭐ 55 | 🐛 37 | 🌐 Python | 📅 2026-04-27 - Import WordPress blog content from an XML file into Wagtail.
* [cookiecutter-wagtail-vix](https://github.com/engineervix/cookiecutter-wagtail-vix) ⭐ 39 | 🐛 14 | 🌐 Python | 📅 2026-05-02 - A matteries-included, reusable project skeleton to serve as a starting point for a Wagtail project.
...
* [cookiecutter-wagtail-package](https://github.com/wagtail/cookiecutter-wagtail-package) ⭐ 22 | 🐛 4 | 🌐 Python | 📅 2026-04-22 - A cookiecutter template for building Wagtail add-on packages.
...
* [Wagtail news template](https://github.com/wagtail/news-template) ⭐ 173 | 🐛 71 | 🌐 Python | 📅 2026-03-13
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,308 | 🐛 994 | 🌐 Python | 📅 2026-05-01 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,076 | 🐛 46 | 🌐 Python | 📅 2026-05-04 – Next generation Wagtail demo, born in Reykjavík.
* [Consumer Financial Protection Bureau](https://github.com/cfpb/consumerfinance.gov) ⭐ 326 | 🐛 39 | 🌐 Python | 📅 2026-04-30 – The source code of the Wagtail-powered consumerfinance.gov is available here on GitHub.
...
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 476 | 🌐 Python | 📅 2026-05-01 – The content management system (CMS) for the new Federal Election Commission website.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 43 | 🐛 81 | 🌐 Python | 📅 2026-05-01 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
* [Wagtail user guide](https://github.com/wagtail/guide) ⭐ 35 | 🐛 69 | 🌐 Python | 📅 2026-04-30 - A website to teach Wagtail to content editors, moderators and administrators.
...
* [torchbox.com](https://github.com/torchbox/torchbox.com) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-04-30 – Wagtail build of Torchbox.com.
