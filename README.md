# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 448,898 | 🐛 88 | 📅 2026-03-09 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,033 | 🐛 0 | 🌐 Python | 📅 2026-03-23 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 289,027 | 🐛 16 | 🌐 Python | 📅 2026-03-25. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,254 | 🐛 1,032 | 🌐 Python | 📅 2026-03-25
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,309 | 🐛 90 | 🌐 TypeScript | 📅 2026-03-24 integration for Wagtail as textfield widget.
...
* [Wagtail Pipit](https://github.com/Frojd/Wagtail-Pipit) ⭐ 255 | 🐛 35 | 🌐 Python | 📅 2026-03-25 – Pipit is a Wagtail boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 64 | 🐛 38 | 🌐 Python | 📅 2026-03-23 - Wagtail template and starter kit from the French government.
...
* [cookiecutter-wagtail-package](https://github.com/wagtail/cookiecutter-wagtail-package) ⭐ 21 | 🐛 3 | 🌐 Python | 📅 2026-03-25 - A cookiecutter template for building Wagtail add-on packages.
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,254 | 🐛 1,032 | 🌐 Python | 📅 2026-03-25 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,077 | 🐛 60 | 🌐 Python | 📅 2026-03-26 – Next generation Wagtail demo, born in Reykjavík.
...
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 483 | 🌐 Python | 📅 2026-03-25 – The content management system (CMS) for the new Federal Election Commission website.
...
* [Wagtail user guide](https://github.com/wagtail/guide) ⭐ 34 | 🐛 66 | 🌐 Python | 📅 2026-03-25 - A website to teach Wagtail to content editors, moderators and administrators.
