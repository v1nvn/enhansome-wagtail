# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,676 | 🐛 68 | 📅 2026-04-19 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,084 | 🐛 2 | 🌐 Python | 📅 2026-04-20 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 294,746 | 🐛 17 | 🌐 Python | 📅 2026-04-27. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,309 | 🐛 996 | 🌐 Python | 📅 2026-04-27
...
* [Wagtail Terms](https://github.com/smark-1/wagtailterms) ⭐ 9 | 🐛 3 | 🌐 Python | 📅 2026-04-27 - A plugin to add a glossary terms entity to the Draftail editor.
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,372 | 🐛 92 | 🌐 TypeScript | 📅 2026-04-19 integration for Wagtail as textfield widget.
...
* [Wagtail ReCaptcha](https://github.com/wagtail-nest/wagtail-django-recaptcha) ⭐ 62 | 🐛 12 | 🌐 Python | 📅 2026-04-18 - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha](https://github.com/django-recaptcha/django-recaptcha) ⭐ 1,037 | 🐛 22 | 🌐 Python | 📅 2026-04-27 field when using the Wagtail formbuilder.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 66 | 🐛 41 | 🌐 Python | 📅 2026-04-27 - Wagtail template and starter kit from the French government.
...
* [cookiecutter-wagtail-vix](https://github.com/engineervix/cookiecutter-wagtail-vix) ⭐ 39 | 🐛 13 | 🌐 Python | 📅 2026-04-26 - A matteries-included, reusable project skeleton to serve as a starting point for a Wagtail project.
...
* [Wagtail news template](https://github.com/wagtail/news-template) ⭐ 171 | 🐛 71 | 🌐 Python | 📅 2026-03-13
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,309 | 🐛 996 | 🌐 Python | 📅 2026-04-27 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,077 | 🐛 44 | 🌐 Python | 📅 2026-04-28 – Next generation Wagtail demo, born in Reykjavík.
...
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 479 | 🌐 Python | 📅 2026-04-27 – The content management system (CMS) for the new Federal Election Commission website.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 42 | 🐛 80 | 🌐 Python | 📅 2026-04-28 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
