# Awesome Wagtail [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,686 | 🐛 61 | 📅 2026-04-02 [<img src="https://cdn.jsdelivr.net/gh/springload/awesome-wagtail@ac912cc661a7099813f90545adffa6bb3e75216c/logo.svg" width="104" align="right" alt="Wagtail">](https://wagtail.org/) with stars
...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,054 | 🐛 2 | 🌐 Python | 📅 2026-03-23 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 291,567 | 🐛 19 | 🌐 Python | 📅 2026-04-09. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,291 | 🐛 1,024 | 🌐 Python | 📅 2026-04-07
...
* [wagtailnews](https://github.com/neon-jungle/wagtailnews) ⭐ 76 | 🐛 4 | 🌐 Python | 📅 2023-12-20 - A plugin for Wagtail that provides news / blogging functionality.
...
* [WagtailDraftail](https://github.com/springload/wagtaildraftail) ⭐ 24 | 🐛 20 | 🌐 Python | 📅 2017-11-08 – Draft.js editor for Wagtail, built upon [Draftail](https://github.com/springload/draftail) ⭐ 631 | 🐛 31 | 🌐 TypeScript | 📅 2025-09-29 and [draftjs\_exporter](https://github.com/springload/draftjs_exporter) ⭐ 83 | 🐛 1 | 🌐 Python | 📅 2026-03-26.
...
* [Wagtail Terms](https://github.com/smark-1/wagtailterms) ⭐ 9 | 🐛 1 | 🌐 Python | 📅 2026-03-09 - A plugin to add a glossary terms entity to the Draftail editor.
...
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,338 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-07 integration for Wagtail as textfield widget.
...
* [wagtail-markdown](https://github.com/torchbox/wagtail-markdown) ⭐ 217 | 🐛 13 | 🌐 Python | 📅 2026-04-06 - Markdown fields and blocks for Wagtail.
* [Wagtail-Geo-Widget](https://github.com/Frojd/wagtail-geo-widget) ⭐ 149 | 🐛 11 | 🌐 Python | 📅 2025-11-09 - Google Maps widget for the GeoDjango PointField field in Wagtail.
* [wagtail-autocomplete](https://github.com/wagtail/wagtail-autocomplete) ⭐ 130 | 🐛 52 | 🌐 Python | 📅 2026-03-10 - Autocompleting choosers for `ForeignKey`, `ParentalKey`, and `ManyToMany` fields.
...
* [wagtail-color-panel](https://github.com/marteinn/wagtail-color-panel) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2025-11-23 - Introduces panels for selecting colors in Wagtail.
...
* [Wagtail Code Block](https://github.com/wagtail-nest/wagtailcodeblock) ⭐ 171 | 🐛 5 | 🌐 Python | 📅 2025-12-19 - StreamField code blocks for the Wagtail CMS with real-time PrismJS Syntax Highlighting.
...
* [wagtail-inventory](https://github.com/cfpb/wagtail-inventory) ⭐ 64 | 🐛 4 | 🌐 Python | 📅 2026-04-09 - Search Wagtail pages by the StreamField blocks they contain.
...
* [Wagtail-bakery](https://github.com/wagtail-nest/wagtail-bakery) ⭐ 194 | 🐛 20 | 🌐 Python | 📅 2025-01-02 - A set of helpers for baking your Django Wagtail site out as flat files.
...
* [Wagtail-Flags](https://github.com/cfpb/wagtail-flags) ⭐ 90 | 🐛 2 | 🌐 Python | 📅 2026-04-08 - Feature flags for Wagtail sites.
...
* [django-salesman](https://github.com/dinoperovic/django-salesman) ⭐ 423 | 🐛 10 | 🌐 Python | 📅 2025-09-24 - Headless e-commerce framework for Django with Wagtail modeladmin integration.
* [longclaw](https://github.com/longclawshop/longclaw) ⭐ 403 | 🐛 46 | 🌐 Python | 📅 2023-08-13 - A shop template for Wagtail CMS.
...
* [Wagtail Personalisation](https://github.com/wagtail-nest/wagtail-personalisation) ⭐ 127 | 🐛 56 | 🌐 Python | 📅 2026-01-27 - Personalisation module, enabling editors to create customised pages - or parts of pages - based on segments whose rules are configured directly in the admin interface.
* [Wagtail Experiments](https://github.com/torchbox/wagtail-experiments) ⭐ 108 | 🐛 9 | 🌐 Python | 📅 2025-12-16 – A/B testing for Wagtail.

### Security

* [wagtail-2fa](https://github.com/labd/wagtail-2fa) ⭐ 92 | 🐛 18 | 🌐 Python | 📅 2026-04-03 - Add two-factor authentication to Wagtail by integrating it with django-otp.
...
* [wagtailmedia](https://github.com/torchbox/wagtailmedia) ⭐ 249 | 🐛 26 | 🌐 Python | 📅 2026-04-06 - A Wagtail module for managing video and audio files within the admin.
...
* [Wagtail Localize](https://github.com/wagtail/wagtail-localize) ⭐ 251 | 🐛 160 | 🌐 Python | 📅 2026-04-06 - A translation plugin for the Wagtail CMS, allows pages or snippets to be translated within Wagtail's admin interface.
* [Wagtail Modeltranslation](https://github.com/infoportugal/wagtail-modeltranslation) ⭐ 155 | 🐛 29 | 🌐 Python | 📅 2026-02-03 - Simple app containing a mixin model that integrates [django-modeltranslation](https://github.com/deschler/django-modeltranslation) ⭐ 1,470 | 🐛 130 | 🌐 Python | 📅 2026-04-05 into Wagtail panels system.
...
* [Wagtail ReCaptcha](https://github.com/wagtail-nest/wagtail-django-recaptcha) ⭐ 62 | 🐛 19 | 🌐 Python | 📅 2025-02-20 - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha](https://github.com/django-recaptcha/django-recaptcha) ⭐ 1,038 | 🐛 22 | 🌐 Python | 📅 2026-03-16 field when using the Wagtail formbuilder.
...
* [Wagtail Model Forms](https://github.com/vicktornl/wagtail-model-forms) ⭐ 11 | 🐛 5 | 🌐 Python | 📅 2026-03-17 - The Wagtail Form Builder functionalities available for your models/snippets.
...
* [Wagtail Simple Captcha](https://github.com/acarasimon96/wagtail-django-simple-captcha) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2020-05-06 - A self-hosted alternative to Wagtail ReCaptcha that easily integrates a [django-simple-captcha](https://github.com/mbi/django-simple-captcha) ⭐ 1,427 | 🐛 39 | 🌐 Python | 📅 2025-12-07 field into the Wagtail form builder.
* [Wagtail's built in Form Builder](https://docs.wagtail.org/en/stable/reference/contrib/forms/) for general use cases.

### Testing

* [Wagtail Factories](https://github.com/wagtail/wagtail-factories) ⭐ 112 | 🐛 24 | 🌐 Python | 📅 2026-02-10 - Factory boy classes for Wagtail.
...
* [Wagtail Accessibility](https://github.com/wagtail-nest/wagtail-accessibility) ⭐ 34 | 🐛 6 | 🌐 Python | 📅 2024-11-20 – A plugin to assist with accessibility when developing in Wagtail.
...
* [wagtail-treemodeladmin](https://github.com/cfpb/wagtail-treemodeladmin) ⭐ 53 | 🐛 4 | 🌐 Python | 📅 2026-04-09 - Page explorer-like navigation of Django model relationships using ModelAdmin.
...
* [Wagtail Headless Preview](https://github.com/torchbox/wagtail-headless-preview) ⭐ 139 | 🐛 6 | 🌐 Python | 📅 2026-04-06 - Previews for headless Wagtail setups
* [Wagtail Transfer](https://github.com/wagtail/wagtail-transfer) ⭐ 110 | 🐛 42 | 🌐 Python | 📅 2026-02-07 - An official extension for Wagtail allowing content to be transferred between multiple instances of a Wagtail project
...
* [Wagtail Content Import](https://github.com/torchbox/wagtail-content-import) ⭐ 37 | 🐛 7 | 🌐 Python | 📅 2026-04-06 - Import content from Google Docs or Docx into StreamFields, using a customisable mapping system.
...
* [wagtailmenus](https://github.com/jazzband/wagtailmenus) ⭐ 419 | 🐛 20 | 🌐 Python | 📅 2026-04-02 - An extension for Torchbox's Wagtail CMS to help you manage and render multi-level navigation and simple flat menus in a consistent, flexible way.
* [Wagtail Grapple](https://github.com/torchbox/wagtail-grapple) ⭐ 159 | 🐛 63 | 🌐 Python | 📅 2026-04-06 - A Wagtail app that makes building GraphQL endpoints a breeze.
...
* [Wagtail Pipit](https://github.com/Frojd/Wagtail-Pipit) ⭐ 255 | 🐛 39 | 🌐 Python | 📅 2026-04-08 – Pipit is a Wagtail boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
...
* [State Design System (DSFR) starter](https://github.com/numerique-gouv/sites-faciles) ⭐ 65 | 🐛 41 | 🌐 Python | 📅 2026-04-09 - Wagtail template and starter kit from the French government.
* [Wordpress to Wagtail migration kit](https://github.com/wagtail/wagtail-wordpress-import) ⭐ 55 | 🐛 37 | 🌐 Python | 📅 2026-03-16 - Import WordPress blog content from an XML file into Wagtail.
* [cookiecutter-wagtail-vix](https://github.com/engineervix/cookiecutter-wagtail-vix) ⭐ 39 | 🐛 14 | 🌐 Python | 📅 2026-03-26 - A matteries-included, reusable project skeleton to serve as a starting point for a Wagtail project.
...
* [cookiecutter-wagtail-package](https://github.com/wagtail/cookiecutter-wagtail-package) ⭐ 21 | 🐛 4 | 🌐 Python | 📅 2026-04-09 - A cookiecutter template for building Wagtail add-on packages.
...
* [Wagtail news template](https://github.com/wagtail/news-template) ⭐ 166 | 🐛 71 | 🌐 Python | 📅 2026-03-13
...
* [Contributed apps and website code](https://github.com/wagtail/wagtail/wiki/Contributed-apps-and-website-code) ⭐ 20,291 | 🐛 1,024 | 🌐 Python | 📅 2026-04-07 - A provisional directory of third-party contributed Wagtail websites and apps.
...
* [bakerydemo](https://github.com/wagtail/bakerydemo) ⭐ 1,075 | 🐛 42 | 🌐 Python | 📅 2026-04-10 – Next generation Wagtail demo, born in Reykjavík.
* [Consumer Financial Protection Bureau](https://github.com/cfpb/consumerfinance.gov) ⭐ 326 | 🐛 38 | 🌐 Python | 📅 2026-04-09 – The source code of the Wagtail-powered consumerfinance.gov is available here on GitHub.
* [Outreachy website](https://github.com/outreachy/website/) ⭐ 297 | 🐛 209 | 🌐 HTML | 📅 2026-04-09 - Website for Outreachy, who provide internships in open source and open science.
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 106 | 🐛 488 | 🌐 Python | 📅 2026-04-09 – The content management system (CMS) for the new Federal Election Commission website.
...
* [WesternFriend](https://github.com/WesternFriend/westernfriend.org) ⭐ 61 | 🐛 23 | 🌐 Python | 📅 2026-04-05 - community website with directory, ecommerce, and online subscription
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 42 | 🐛 80 | 🌐 Python | 📅 2026-04-09 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
* [Wagtail user guide](https://github.com/wagtail/guide) ⭐ 34 | 🐛 68 | 🌐 Python | 📅 2026-03-25 - A website to teach Wagtail to content editors, moderators and administrators.
...
* [torchbox.com](https://github.com/torchbox/torchbox.com) ⭐ 8 | 🐛 6 | 🌐 Python | 📅 2026-04-07 – Wagtail build of Torchbox.com.
...
* [Penticon Public Library](https://github.com/danlerche/public-library-wagtailCMS) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-18 - An example public library website, originally created for the Penticton Public Library in Penticton, British Columbia, Canada.
